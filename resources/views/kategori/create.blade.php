...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('kategori') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                <label class="col-1 control-label col-form-label">name Kategori</label>
                <div class="col-11">
                    <input type="text" class="form-control" id="kategori_name" name="kategori_name" value="{{ old('kategori_name') }}" required>
                    @error('kategori_name')
                    <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
